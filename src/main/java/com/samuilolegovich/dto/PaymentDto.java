...
//    private static final String Destination = "rUCzEr6jrEyMpjhs4wSdQdz4g8Y382NxfM";
    ...
    private String amount;              // Сумма XRP для отправки («Сумма»). Обычно это целое число в «каплях» XRP, где 1000000 капель равняется 1 XRP.
    private String destination;         // Адрес, на который должен быть получен XRP («Пункт назначения»). Это не может совпадать с адресом отправки.
}
